...
export default function CatalogPage({ params }: PageProps) {
  ...
  return (
    <>
      <Bread />
      <div className="p-[30px] mb-[50px] bg-white rounded-lg mt-[10px]">
        <div className="flex justify-between">
          <div className="flex gap-[30px] mb-[40px]">
            <Image src={"/1.png"} alt="png" width={210} height={50} />
            <div className="flex flex-col">
              <p className="font-[var(--font3)] font-bold text-[30px] leading-[100%] mb-[10px] text-[#222]">
 ...
 h-[40px] w-[200px] text-white font-bold text-[14px] rounded-[8px] px-[32px] py-[10px] sm:w-[235px] text-center cursor-pointer"
          >
            Получить деньги
          </div>
        </div>

        <h2 className="mb-[30px] font-[var(--font3)] font-bold text-[36px] leading-[100%] text-[#222]">
      ...
      <div className=" flex w-full gap-[20px]">
        <div className="p-[30px] w-1/2 mb-[50px] bg-white rounded-lg mt-[10px]">
          <h2
