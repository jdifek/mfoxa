...
const DropdownComponent: React.FC<DropdownProps> = ({ options }) => {
  ...
  return (
    <div className="relative my-5 w-full sm:w-[170px]">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="h-[40px] w-full px-[10px] py-[11px] bg-white border border-[#BCBCCC] rounded-[8px] flex justify-between items-center text-[12px] font-medium text-[#222] leading-[142%]"
      >
        {selected}
        <svg
