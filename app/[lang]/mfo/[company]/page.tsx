	...
	const requirementsData = [
		...
		},
		{
			...
			value:
				...
				t("borrower.documentsValue"),
		},
		{
			key: "citizenship",
			label: t("borrower.citizenship"),
			value:
				requirements?.residency_requirement ||
				t("borrower.citizenshipValue"),
		},
		{
			key: "collateral",
		...
		},
		{
			...
			value:
				requirements?.employment_requirement ||
		...
		<>
			...
			<div className="px-0 md:px-[20px]">
				<div className="p-[10px] md:p-[30px] sm:p-[20px] mb-[30px] md:mb-[50px] bg-white rounded-lg mt-[10px]">
						...
						<div className="flex gap-[10px] md:p-[30px] sm:p-[20px] mb-[16px] md:mb-[40px]">
							...
							<div className="flex flex-col">
								...
								<div className="flex gap-[5px] items-center">
									...
									<Link
										href={`/${lang}/mfo/${data.slug}/reviews`}
									>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 mb-[10px]">
						<div className="flex flex-col gap-[10px]">
							...
							<p className="font-bold text-[14px] leading-[136%] text-[#222]">
								{data.legal_entity ||
									t(`company.${companySlug}.legalEntity`)}
							</p>
						</div>
					...
					<Link
						href={
							data.basic_characteristics_pdf_url || t("termsLink")
						}
