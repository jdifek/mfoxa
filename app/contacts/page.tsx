...
text-[#222] mb-[14px] sm:mb-[25px] md:mb-[30px]"
  ...
  "
          ...
          >
            ...
            материалы, представленные на сайте, имеют исключительно
            ознакомительный характер. Подробные и точные условия кредитования
            необходимо уточнять на официальных сайтах соответствующих банков,
            МФО или других финансовых учреждений.
          </p>
        </div>
      </div>
